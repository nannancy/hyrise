        ...
        resolve_data_type(data_type, [&, aggregate](auto type) {
          ...
          switch (aggregate->aggregate_function) {
            case AggregateFunction::Min:
              _aggregate_segment<ColumnDataType, AggregateFunction::Min, AggregateKey, false>(chunk_id, aggregate_idx,
                                                                                       *base_segment, keys_per_chunk);
              break;
            case AggregateFunction::Max:
              _aggregate_segment<ColumnDataType, AggregateFunction::Max, AggregateKey, false>(chunk_id, aggregate_idx,
                                                                                       *base_segment, keys_per_chunk);
              break;
            case AggregateFunction::Sum:
              _aggregate_segment<ColumnDataType, AggregateFunction::Sum, AggregateKey, false>(chunk_id, aggregate_idx,
                                                                                       *base_segment, keys_per_chunk);
              break;
            case AggregateFunction::Avg:
              _aggregate_segment<ColumnDataType, AggregateFunction::Avg, AggregateKey, false>(chunk_id, aggregate_idx,
                                                                                       *base_segment, keys_per_chunk);
              break;
            case AggregateFunction::Count:
              _aggregate_segment<ColumnDataType, AggregateFunction::Count, AggregateKey, false>(chunk_id, aggregate_idx,
                                                                                         *base_segment, keys_per_chunk);
              break;
            ...
            case AggregateFunction::Any:
              _aggregate_segment<ColumnDataType, AggregateFunction::Any, AggregateKey, false>(chunk_id, aggregate_idx,
                                                                                       *base_segment, keys_per_chunk);
          }
        });
